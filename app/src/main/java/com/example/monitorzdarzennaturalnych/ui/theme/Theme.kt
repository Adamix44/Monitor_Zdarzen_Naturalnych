...
// Powierzchnia z przezroczystością
...
@Composable
fun MonitorTheme(darkTheme: Boolean = isSystemInDarkTheme(), content: @Composable () -> Unit) {
    ...
    MaterialTheme(colorScheme = colorScheme, typography = MonitorTypography, content = content)
}
